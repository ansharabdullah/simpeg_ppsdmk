    ...
    <div class="widgetcontent nopadding">
        <form class="stdform stdform2" action="<?php echo site_url('Pegawai/proses_edit_log_diklat') ?>" method="post">
            ...
            <div class="par">
                ...
                <span class="field"><input id="datepicker" type="date" name="tanggal_ijazah" class="input-small" value="<?php echo $TGL_IJAZAH_DIKLAT;?>" /></span>
            </div>
           ...
           <p>
            ...
            <p>
                ...
                <span class="field"><input type="text" name="rangking" class="input-small" placeholder="" value="<?php echo $RANGKING_DIKLAT;?>"/></span>
            </p>
