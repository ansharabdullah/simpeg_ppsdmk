<div class="widgetbox box">
            <h4 class="widgettitle">RIWAYAT TUGAS KE LUAR NEGERI</h4>
            <div class="widgetcontent nopadding">
                <form class="stdform stdform2" action="" method="post">
       
                     <p>
                        <label>Negara</label>
                        <span class="field"><input type="text" name="negara" class="input-large" placeholder="" /></span>
                    </p>
                    ...
                    <div class="par">
                        ...
                        <span class="field"><input id="datepicker" type="date" name="tanggal_sk" class="input-xlarge" /></span>
                    </div> 
