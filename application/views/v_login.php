...
<div class="loginpanel">
    <div class="loginpanelinner">
        <div class="logo animate0 bounceIn"><img src="<?php echo base_url();?>assets/shamcey/images/logi.png" alt="" width="55%"/></div>
        <form id="login" action="<?php echo base_url(); ?>login/submit_login" method="post">
...
<div class="loginfooter">
    <p>&copy; 2013. PT. Semprot Packaging. All Rights Reserved.</p>
</div>
</center>
</body>
</html>
