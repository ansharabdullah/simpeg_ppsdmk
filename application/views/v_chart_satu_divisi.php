					...
					point: {
						events: {
							click: function() {									
								...
								window.location.href = '<?php echo base_url(); ?>manager/pegawai/' + nama+ '/<?php echo $periode; ?>'; 
							}
						}
					}
				}
...
<div id="dashboard-left" class="span8" style="width:55%;">
<h4 class="widgettitle"><span class="icon-tasks icon-white"></span>Statistik Kinerja <?php echo $title;?></h4>
