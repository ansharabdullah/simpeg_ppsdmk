...
class m_grafik extends CI_Model {
    ...
    public function tabelPegawaiDivisi($id_divisi) {
        $query = $this->db->query("SELECT P.NIP, P.NAMA_PEGAWAI, P.JENIS_KELAMIN, JG.GOLONGAN, J.JABATAN, U.NAMA_UNIT "
                . "FROM PEGAWAI P, UNIT_KERJA U, LOG_JABATAN LJ, JABATAN J, LOG_KEPANGKATAN LK, JENIS_GOLONGAN JG "
                . "WHERE LJ.ID_UNIT=U.ID_UNIT AND P.ID_PEGAWAI=LJ.ID_PEGAWAI AND LJ.ID_JENIS_JABATAN=J.ID_JENIS_JABATAN AND P.ID_PEGAWAI=LK.ID_PEGAWAI AND LK.ID_JENIS_GOLONGAN=JG.ID_JENIS_GOLONGAN AND LJ.STATUS_JABATAN=1 AND P.STATUS_AKTIF=1 AND J.BAGIAN='$id_divisi'");
        return $query->result();
    }
